...
namespace HotelReviewApp.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        [HttpGet("Hotel/{categoryId}")]
        [ProducesResponseType(200, Type = typeof(IEnumerable<Hotel>))]
        [ProducesResponseType(400)]
        public IActionResult GetHotelByCategoryId(int categoryId)
        {
            var hotels = _mapper.Map<List<HotelDto>>(
                _categoryRepository.GetHotelByCategory(categoryId));
