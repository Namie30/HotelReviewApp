...
namespace HotelReviewApp.Controllers
{
    ...
    public class ReviewController : Controller
    {
        ...
        [ProducesResponseType(200, Type = typeof(IEnumerable<ReviewDto>))]
        [ProducesResponseType(400)]
        public IActionResult GetReviewsForAHotel(int hotelId)
        {
            var reviews = _mapper.Map<List<ReviewDto>>(_reviewRepository.GetReviewsOfAHotel(hotelId));
        ...
        [ProducesResponseType(400)]
        public IActionResult CreateReview([FromQuery] int reviewerId, [FromQuery] int hotelId, [FromBody] ReviewDto reviewCreate)
        {
    ...
    public interface IReviewRepository
    {
        ...
        ICollection<Review> GetReviewsOfAHotel(int hotelId); 
